const BUILD_REVISION = "__TEN_REALMS_V3_BUILD_REVISION__";
const CACHE_NAME = `ten-realms-v3-arcade-${
  ...
  event.waitUntil(
    caches.keys()
      .then((keys) => Promise.all(
        keys
          .filter((key) => key.startsWith("ten-realms-v3-arcade-") && key !== CACHE_NAME)
