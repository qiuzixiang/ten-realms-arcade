import { V3_PROGRESS_KEY, readStoredJson } from "./shared/storage.mjs";
...
function validateRegistry(registry) {
  ...
  if (registry.schemaVersion !== 1 || registry.edition !== "3.0" || registry.status !== "ready") {
...
const storedProgress = readStoredJson(V3_PROGRESS_KEY, null);
