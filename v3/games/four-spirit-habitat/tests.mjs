...
equal(LEVELS.length, 6, "V3.0 Map must publish six levels");
...
check(STORAGE_PREFIX.startsWith("ten-realms-v3:games:four-spirit-habitat:"), "private storage prefix is isolated");
...
check(app.includes('window.addEventListener("ten-realms-v3:realm-ready", flushCompletionOutbox)'), "the V3 ready alias retries the durable outbox");
