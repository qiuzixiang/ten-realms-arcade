...
check(STORAGE_PREFIX.startsWith("ten-realms-v3:games:molten-core-vent:"));
...
check(/<html[^>]+data-realm="molten-core-vent"[^>]+data-game-version="3\.0"/.test(files["index.html"]));
