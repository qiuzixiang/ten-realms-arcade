...
check(STORAGE_PREFIX.startsWith("ten-realms-v3:games:paper-crane-sanctuary:"));
...
check(files["app.mjs"].includes('addEventListener("ten-realms-v3:realm-ready"'));
...
check(/focusBeforeDialog !== document\.body[\s\S]*?elements\.tutorialButton/.test(files["app.mjs"]), "自动打开教程结束后必须回到图片教程入口，而非 body");
