...
function closeDialog(dialog, restore = true) {
  ...
  if (restore) (focusBeforeDialog instanceof HTMLElement ? focusBeforeDialog : elements.tutorialButton)?.focus({ preventScroll: true });
}
...
window.addEventListener("ten-realms-v2:realm-ready", retryOutbox);
