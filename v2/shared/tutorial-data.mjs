...
function mysticPerfumery(focus) {
  if (focus === "action") return svg("四个香槽已经放满精华，第二槽带留香签，右侧聚合反馈显示两个完全命中与一个成分命中", focus, `
    ...
    <g class="art-action" font-family="ui-sans-serif, system-ui, sans-serif">
      ...
      <g transform="translate(224 91)"><path d="M12 0l4 8 8-4-4 8 8 4-8 4 4 8-8-4-4 8-4-8-8 4 4-8-8-4 8-4-4-8 8 4z" fill="#8f4962"/><path d="M46 2l12 12-12 12-12-12z" fill="none" stroke="#b99ac2" stroke-width="3"/><text x="29" y="49" text-anchor="middle" fill="#eadcf0" font-size="9" font-weight="800">完全 2 · 成分 1</text></g>
    </g>`);
...
function neonSkyline(focus) {
  if (focus === "action") return svg("选中的城市地块从候选蓝图切换为三层霓虹建筑", focus, `
    ...
    <g class="art-action"><g fill="none" stroke="#5cf6ff55">${grid(42, 34, 4, 3, 36, "#5cf6ff55")}</g><rect x="78" y="70" width="36" height="36" fill="#112a46" stroke="#ff4fd8" stroke-width="3"/><g fill="#a7c7da" font-size="9" font-weight="800" text-anchor="middle"><text x="88" y="83">1</text><text x="104" y="83">2</text><text x="88" y="99">3</text><text x="104" y="99">4</text></g><path d="M96 64V42" stroke="#ff4fd8" stroke-width="3" stroke-linecap="round"/><path d="M90 48l6-8 6 8" fill="none" stroke="#ff4fd8" stroke-width="3"/><g transform="translate(198 106)"><path d="M-22 0V-54H22V0" fill="#153455" stroke="#5cf6ff" stroke-width="3"/><g fill="#ffcf5a"><rect x="-14" y="-44" width="8" height="6"/><rect x="5" y="-44" width="8" height="6"/><rect x="-14" y="-28" width="8" height="6"/><rect x="5" y="-28" width="8" height="6"/><rect x="-14" y="-12" width="8" height="6"/><rect x="5" y="-12" width="8" height="6"/></g><circle cx="0" cy="-27" r="13" fill="#071326" stroke="#ff4fd8" stroke-width="2"/><text x="0" y="-22" text-anchor="middle" fill="#fff" font-size="15" font-weight="900">3</text></g><g transform="translate(254 52)" font-size="11" font-weight="900" text-anchor="middle"><rect x="-18" y="-13" width="36" height="26" rx="8" fill="#ff4fd8"/><text y="4" fill="#160d28">3 层</text></g></g>`);
  if (focus === "goal") return svg("四乘四街区每行每列高度不重复，四边可见数全部通过", focus, `
    <rect x="18" y="14" width="284" height="156" rx="18" fill="#071326"/>
    <g class="art-goal"><g transform="translate(88 24)">${grid(0, 0, 4, 4, 32, "#5cf6ff66")}<g font-size="14" font-weight="900" text-anchor="middle" fill="#eafdff"><text x="16" y="22">1</text><text x="48" y="22">3</text><text x="80" y="22">4</text><text x="112" y="22">2</text><text x="16" y="54">4</text><text x="48" y="54">2</text><text x="80" y="54">3</text><text x="112" y="54">1</text><text x="16" y="86">2</text><text x="48" y="86">4</text><text x="80" y="86">1</text><text x="112" y="86">3</text><text x="16" y="118">3</text><text x="48" y="118">1</text><text x="80" y="118">2</text><text x="112" y="118">4</text></g></g><g fill="#ffcf5a" font-size="12" font-weight="900" text-anchor="middle"><text x="104" y="18">2</text><text x="136" y="18">2</text><text x="168" y="18">1</text><text x="200" y="18">3</text><text x="72" y="46">3</text><text x="72" y="78">1</text><text x="72" y="110">2</text><text x="72" y="142">2</text></g><path d="M244 86l10 10 22-30" fill="none" stroke="#65ffaf" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/><path d="M32 142H286" stroke="#ff4fd8" stroke-width="3" stroke-dasharray="8 6"/></g>`);
