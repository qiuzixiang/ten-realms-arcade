const BUILD_REVISION = "__TEN_REALMS_V2_BUILD_REVISION__";
const CACHE_NAME = `ten-realms-v2-arcade-${
  ...
  event.waitUntil(
    caches.keys()
      .then((keys) => Promise.all(
        keys
          .filter((key) => key.startsWith("ten-realms-v2-arcade-") && key !== CACHE_NAME)
